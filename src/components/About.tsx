        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <GlowCard
              ...
              title="Education"
              content={[
                { title: "B.Tech in Computer Engineering", institution: "BMIT, Solapur (2021–2025)" },
                { title: "Higher Secondary Certificate", institution: "Ad Joshi Junior College, Solapur (2021)" },
                { title: "Secondary School Certificate", institution: "St. Thomas English Medium School, Solapur (2019)" },
              ]}
            />
            ...
            <GlowCard
              ...
              content={[
                ...
                "PhysicsWallah: Decode DSA with C++",
              ]}
            />
          </div>
        </div>
...
function GlowCard({ icon, title, content }: any) {
  return (
    <motion.div
      className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md"
      ...
      whileTap={{
        boxShadow: '0px 0px 40px rgba(0, 255, 255, 1)',
        scale: 1.1,
      }}
    >
      <div className="flex items-center mb-4">
...
{`
  @media (hover: none) {
    .neon-card:hover {
      box-shadow: 0px 0px 30px rgba(0, 255, 255, 0.8) !important;
      transform: scale(1.08) !important;
    }
    .neon-card:active {
      box-shadow: 0px 0px 50px rgba(0, 255, 255, 1) !important;
