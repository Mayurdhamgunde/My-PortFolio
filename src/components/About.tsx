...
//               whileInView="visible"
//               viewport={{ once: true }}
//               whileHover={{ boxShadow: '0px 0px 20px rgba(0, 255, 255, 0.6)', scale: 1.05, background: 'linear-gradient(135deg, rgba(0, 255, 255, 0.15), rgba(0, 128, 255, 0.15))' }}
//               whileTap={{ scale: 0.95 }}
//             >
//               <div className="flex items-center mb-4">
//                 <GraduationCap className="text-blue-600 mr-3" size={24} />
...
//             <motion.div
//               className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md"
//               whileHover={{ boxShadow: '0px 0px 15px rgba(0, 255, 255, 0.8)', scale: 1.05, background: 'linear-gradient(135deg, rgba(0, 255, 255, 0.15), rgba(0, 128, 255, 0.15))' }}
//               whileTap={{ scale: 0.95 }}
//             >
//               <div className="flex items-center mb-4">
//                 <Users className="text-blue-600 mr-3" size={24} />
