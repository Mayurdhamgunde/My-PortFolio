...
//         <motion.h2
//           className="text-3xl font-bold text-center mb-12 text-gray-900 dark:text-white"
//           whileHover={{ scale: 1.1, textShadow: '0px 0px 12px rgba(128, 0, 255, 0.9)', background: 'linear-gradient(135deg, rgba(255, 0, 128, 0.25), rgba(0, 128, 255, 0.25))', WebkitBackgroundClip: 'text', color: 'transparent' }}
//         >
//           Achievements & Activities
//         </motion.h2>
//         <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-8">
...
//             <motion.div
//               key={index}
//               className=" dark:bg-gray-800 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all"
//               variants={cardVariants}
//               initial="hidden"
//               whileInView="visible"
//               viewport={{ once: true }}
...
//             <motion.div
//               key={index}
//               className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all border border-gray-200 dark:border-gray-700"
//               variants={cardVariants}
//               initial="hidden"
//               whileInView="visible"
//               viewport={{ once: true }}
